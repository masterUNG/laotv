...
import static com.royle.latv.SplashScreen.DIALOG_ERROR_CONNECTION;
   ...
   /* public void LoginApp(String username, String password) {
    ...
    public class RefillCodeTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            String resultData = portalServices.makePortalCall(null, "http://mvdtv.com/code/re",
                    PortalServices.POST, list);
